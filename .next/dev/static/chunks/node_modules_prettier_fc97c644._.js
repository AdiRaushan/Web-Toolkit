...
"[project]/node_modules/prettier/plugins/html.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(function(f) {
    ...
    var en = (e, t)=>{
        ...
        if (t && typeof t == "object" || typeof t == "function") for (let i of ks(t))!xs.call(e, i) && i !== r && St(e, i, {
            get: ()=>t[i],
            enumerable: !(n = ws(t, i)) || n.enumerable
        });
        return e;
    };
    var Ns = (e)=>ys(St({}, "__esModule", {
            value: !0
        }), e);
    ...
    var Rs = ()=>{}, ze = Rs;
    var Ye = "string", je = "array", Et = "cursor", Ae = "indent", ye = "align", Ct = "trim", Ne = "group", Le = "fill", Pe = "if-break", Oe = "indent-if-break", vt = "line-suffix", Tt = "line-suffix-boundary", Y = "line", bt = "label", De = "break-parent", wt = new Set([
        Et,
        Ae,
        ye,
        Ct,
...
`)) : r);
    ...
    function C(e, t = {}) {
        return D(e), xt(t.expandedStates, !0), {
            type: Ne,
            id: t.id,
            contents: e,
            break: !!t.shouldBreak,
...
`)), F(0, u, -1).length;
    ...
    function yn(e, t) {
        ...
        ;
        function n() {
            return ce(e) || e.kind === "angularControlFlowBlock" ? !1 : (e.kind === "text" || e.kind === "interpolation") && e.prev && (e.prev.kind === "text" || e.prev.kind === "interpolation") ? !0 : !e.parent || e.parent.cssDisplay === "none" ? !1 : pe(e.parent) ? !0 : !(!e.prev && (e.parent.kind === "root" || pe(e) && e.parent || H(e.parent, t) || Je(e.parent, t) || !_a(e.parent.cssDisplay)) || e.prev && !Ca(e.prev.cssDisplay));
        }
    }
    function Nn(e, t) {
        return ce(e) || e.kind === "angularControlFlowBlock" ? !1 : (e.kind === "text" || e.kind === "interpolation") && e.next && (e.next.kind === "text" || e.next.kind === "interpolation") ? !0 : !e.parent || e.parent.cssDisplay === "none" ? !1 : pe(e.parent) ? !0 : !(!e.next && (e.parent.kind === "root" || pe(e) && e.parent || H(e.parent, t) || Je(e.parent, t) || !Sa(e.parent.cssDisplay)) || e.next && !Ea(e.next.cssDisplay));
    }
    function Ln(e, t) {
    ...
    function Pn(e) {
        return _r(e) || e.kind === "element" && e.children.length > 0 && ([
            ...
            "script",
            "style"
        ].includes(e.name) || e.children.some((t)=>ma(t))) || e.firstChild && e.firstChild === e.lastChild && e.firstChild.kind !== "text" && Dn(e.firstChild) && (!e.lastChild.isTrailingSpaceSensitive || In(e.lastChild));
    }
    function _r(e) {
    ...
    var ya = new Set(vr), Yn = ({ node: e }, t)=>ya.has(e.fullName) && !t.parentParser && !e.value.includes("{{"), jn = (e, t, r)=>x(b(r.node), e, {
            parser: "babel",
...
` || e === "\f" || e === "\r" || e === " ";
    ...
    function Ra(e) {
        ...
        function S() {
            let m = !1, g, E, P, z, le = {}, ee, _t, ke, Ge, ir;
            for(z = 0; z < n.length; z++)ee = n[z], _t = ee[ee.length - 1], ke = ee.substring(0, ee.length - 1), Ge = parseInt(ke, 10), ir = parseFloat(ke), Zn.test(ke) && _t === "w" ? ((g || E) && (m = !0), Ge === 0 ? m = !0 : g = Ge) : Ia.test(ke) && _t === "x" ? ((g || E || P) && (m = !0), ir < 0 ? m = !0 : E = ir) : Zn.test(ke) && _t === "h" ? ((P || E) && (m = !0), Ge === 0 ? m = !0 : P = Ge) : m = !0;
            if (!m) le.source = {
                value: r,
                startOffset: c
            }, g && (le.width = {
...
${e}`;
    ...
    function st(e, t, r) {
        ...
        if (he(n)) {
            ...
            return [
                U(n, t),
                L(y.trimEnd(t.originalText.slice(Q(n) + (n.prev && et(n.prev) ? Ft(n).length : 0), i - (n.next && $(n.next) ? de(n, t).length : 0)))),
                V(n, t)
            ];
        }
        return r();
    ...
    var ao = "boolean", oo = "number", lo = "string", co = "object", uo = [
    ...
    })), po = Array.from(Ii).reduce((e, [t, r])=>(e.set(t, r), e), new Map), Ri = class extends Di {
        constructor(){
            super(), this._schema = new Map, this._eventSchema = new Map, uo.forEach((e)=>{
        ...
        hasElement(e, t) {
            return t.some((r)=>r.name === Ar.name) || e.indexOf("-") > -1 && (wr(e) || kr(e) || t.some((r)=>r.name === xr.name)) ? !0 : this._schema.has(e.toLowerCase());
        }
...
`,
    ...
    var Br = function(e) {
        ...
        constructor(e, t, r){
            ...
            this._cursor = r.escapedString ? new zo(e, n) : new is(e, n), this._preserveLineEndings = r.preserveLineEndings || !1, this._i18nNormalizeLineEndingsInICUs = r.i18nNormalizeLineEndingsInICUs || !1, this._tokenizeBlocks = r.tokenizeBlocks ?? !0, this._tokenizeLet = r.tokenizeLet ?? !0, this._selectorlessEnabled = r.selectorlessEnabled ?? !1;
            try {
                this._cursor.init();
            } catch (i) {
                this.handleError(i);
...
`);
        ...
        _getBlockName() {
            ...
            return this._attemptCharCodeUntilFn((r)=>ct(r) ? !e : Go(r) ? (e = !0, !1) : !0), this._cursor.getChars(t).trim();
        }
        ...
        _tokenizeExpansionForm() {
            ...
            if (Uo(this._cursor.peek()) && this._isInExpansionForm()) return this._consumeExpansionCaseStart(), !0;
    ...
    var N = class os extends ne {
        ...
        parse(e, t, r, n = !1, i) {
            ...
            } : o, r), p = r && r.canSelfClose || !1, d = r && r.allowHtmComponentClosingTags || !1, S = new jo(u.tokens, a, p, d, n);
            return S.build(), new Yo(S.rootNodes, [
                ...u.errors,
                ...S.errors
            ]);
        }
...
`) {
    ...
    function Jt(e, t = {}) {
        ...
        return Xo().parse(e, "angular-html-parser", {
...
`) {
    ...
    var yl = gt(nr), Nl = new Set([
        "mj-style",
        "mj-raw"
    ]), Ll = gt({
        ...nr,
        name: "mjml",
        shouldParseAsRawText: (e)=>Nl.has(e)
    }), Pl = gt({
        name: "angular",
...
//# sourceMappingURL=node_modules_prettier_fc97c644._.js.map